...
export const BUNNY = {
  // Below three URLS are updated based on the new Bunny CDN setup
  STORAGE_BASE_URL: 'https://ny.storage.bunnycdn.com/pavan-snapcase',
  CDN_URL: 'https://pavan-snapcast.b-cdn.net',
  TRANSCRIPT_URL: 'https://vz-c9836cc4-734.b-cdn.net',
